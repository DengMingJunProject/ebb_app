/*
    ...
    ***************************************************************************
    ...
    >>!   obliged to provide the source cod
	
	e for proprietary components     !<<
...
generates a table that shows how much run time each task has */
	...
	{
		"run-stats", /* The command string to type. */
		"\r\nrun-stats:	Displays a table showing how much processing time each FreeRTOS task has used",
